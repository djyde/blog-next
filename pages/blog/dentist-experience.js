...
export default () => (
  <Blog>
    ...
    <p><img src="/static/images/WechatIMG2.jpeg" alt="" /></p>
    ...
    <p><img src="/static/images/tooth-1.jpg" alt="" /></p>
    ...
    <p><img src="/static/images/IMG_5772.JPG" alt="" /></p>

    <p>这是修复前和修复后的侧面对比，可以看出修复前的后牙基本没咬合。</p>

    <p>于是整个修复流程开始。而根管治疗是整个过程中最漫长和痛苦的步骤。即使在手术过程中会注射麻药，疼痛还是存在。</p>

    <p><img src="/static/images/Root_Canal_Illustration_Molar.png" alt="" /></p>
    ...
    <p><img src="/static/images/IMG_5768.JPG" alt="分别是修复前、过程中、修复后的状态" /></p>

    <p>上面分别是修复前、过程中、修复后的状态。</p>

    <p>在修复右边时，有一段小插曲。我的右下智齿阻生并且已经萌出，影响到做牙冠的位置，所以要先把智齿拔掉。拔掉智齿的过程用了两分钟。</p>

    <p><img src="/static/images/IMG_5539.PNG" alt="智齿" /></p>
